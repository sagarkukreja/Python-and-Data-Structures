...
class Kebab:
    ...
    def usage(self):
        ...
        print("calories- number of calories on skewer")
    ...
    def calories(self, args):
         """
         Displays total number of calories in skewer
         :param args:
         :return: None
         """
         if self.skewer:
            result =  self.skewer.calories()
            print("The skewer has " + str(result) + " calories")
         else:
            print("There is no items on skewer")
